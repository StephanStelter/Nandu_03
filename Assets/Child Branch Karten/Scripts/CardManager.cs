...
public class CardManager : MonoBehaviour
{
    ...
    private CardBasicBehavior cardBasicBahavior;
    ...
    private void CreateCardLibrary()
    {
        ...
        CardBasicBehavior[] cardBasicBahaviorsArray = cardLibrary.GetComponentsInChildren<CardBasicBehavior>(true);
    ...
    private IEnumerator SetStatusInLibrary()
    {
        ...
        {
            var cardBehavior = child.GetComponent<CardBasicBehavior>();
    ...
    private void PrepareForNewDeck()
    {
        ...
        {
            CardBasicBehavior gameobjectBasicBehavior = child.GetComponent<CardBasicBehavior>();
    ...
    private void SetStatusCardsInDeck(GameObject instantiatedObject)
    {
        ...
        CardBasicBehavior cardBehaviorInstantiated = instantiatedObject.GetComponent<CardBasicBehavior>();
    ...
    public void SetCardDetailsInWindow(CardPropertiesTest _cardPropertiesTest, CardBasicBehavior _cardBasicBahavior)
    {
    ...
    private void SetCardIDs()
    {
        ...
        foreach (Transform child in cardLibrary.transform)
        {
            CardBasicBehavior cardBehavior = child.GetComponent<CardBasicBehavior>();
